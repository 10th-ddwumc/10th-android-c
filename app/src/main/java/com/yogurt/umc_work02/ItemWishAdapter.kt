...
import com.yogurt.umc_work02.databinding.ItemWishBinding

class ItemWishAdapter (private val itemList: List<ItemData>) :
    RecyclerView.Adapter<ItemWishAdapter.ItemViewHolder>() {
        inner class ItemViewHolder(val binding: ItemWishBinding) :
