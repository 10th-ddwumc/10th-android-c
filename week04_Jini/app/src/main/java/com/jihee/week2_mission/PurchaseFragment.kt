        ...
        lifecycleScope.launch {
            ProductDataStore.getProducts(requireContext())
                .collect { list ->
                    if (list.isEmpty()) {
                        val dummy = listOf(
                            ProductData(R.drawable.ic_product1,"Nike Elite Crew","16$"),
                            ProductData(R.drawable.ic_product2,"Nike Everyday Plus","10$"),
                            ProductData(R.drawable.ic_product3,"Nike Air Force","115$"),
                            ProductData(R.drawable.ic_product5,"Jordan Nike","115$")
                        )
