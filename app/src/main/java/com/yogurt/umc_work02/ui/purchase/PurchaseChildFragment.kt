...
import com.yogurt.umc_work02.databinding.FragmentPurchaseChildBinding
import kotlinx.coroutines.launch

class PurchaseChildFragment : Fragment(){
    private var _binding: FragmentPurchaseChildBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPurchaseChildBinding.inflate(inflater, container, false)
        return binding.root
    }
